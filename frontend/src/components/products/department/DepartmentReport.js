...
import { BASEURL, DEPARTMENTREPORT } from '../../../api/APIEndpoints'
...
export default function DepartmentReport() {
    ...
    const deleteReport=async(data)=>{
        const url=BASEURL+DEPARTMENTREPORT+`/${data._id}`
