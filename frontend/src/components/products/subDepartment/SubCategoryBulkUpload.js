...
import { BASEURL, BULK, SUBDEPARTMENT } from '../../../api/APIEndpoints'
import APIServices from '../../../api/APIServices'

export default function SubCategoryBulkUpload(props) {
    ...
    const submit=async()=>{
        const url=BASEURL+SUBDEPARTMENT+BULK
    ...
    return (
        <div className="textCenter">
            <p className="uploadText">To upload your sub-category click here to choose file.</p>
            <div>
                <input
                    accept=".csv"
                    className='d-none'
