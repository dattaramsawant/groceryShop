...
import { BASEURL, BRANDREPORT,DELETEBULK } from '../../../api/APIEndpoints'
import APIServices from '../../../api/APIServices'
import Modal from '../../../commonComponents/Modal'
import Tables from '../../../commonComponents/Tables'

export default function BrandReportTable(props) {
    ...
    const deleteCategoryReportSuccess=async()=>{
        ...
        if(obj.length>0){
            ...
            const url=BASEURL+BRANDREPORT+DELETEBULK
            const data={
                deleteData:arr
            }
        ...
        <>
            ...
            {deleteModal &&
                <Modal
                    ...
                    size="small"
                    name="Bulk Delete Brand Report"
                >
                    <p>Are you sure you want to delete all selected brand report?</p>
                    <button
                        ...
                        {reportData &&
                            reportData.map((data,i)=>(
                                <tr key={i} className="dataRow">
                                    ...
                                    <td>
                                        {typeof data.brandCategory === 'object' ?
