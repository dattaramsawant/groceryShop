...
import { BASEURL, BRAND, BULK } from '../../../api/APIEndpoints'
import APIServices from '../../../api/APIServices'

export default function BrandBulkUpload(props) {
    ...
    return (
        <div className="textCenter">
            <p className="uploadText">To upload your brand click here to choose file.</p>
            <div>
                <input
                    accept=".csv"
                    className='d-none'
