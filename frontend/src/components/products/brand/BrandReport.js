...
import { BASEURL, BRANDREPORT } from '../../../api/APIEndpoints'
...
export default function BrandReport() {
    ...
    const deleteReport=async(data)=>{
        const url=BASEURL+BRANDREPORT+`/${data._id}`
    ...
    return (
        <>
            ...
            <div className="dashboardMiddleContent">
                <AdminTopBar
                    pageName="Brand Report"
                >
                    <div className="d-flex">
                        <SearchButton
                            tooltip="Search"
                            placeholder="Search Brand Report..."
